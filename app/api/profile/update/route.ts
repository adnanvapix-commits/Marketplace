...
export async function PATCH(req: NextRequest) {
  ...
  // Validate avatar_url must be from our Cloudinary domain if provided
  if (avatar_url && avatar_url.trim()) {
    const isValidUrl = avatar_url.startsWith("https://res.cloudinary.com/") ||
                       avatar_url.startsWith("https://lh3.googleusercontent.com/");
    if (!isValidUrl)
