  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (isSignup) {
        ...
        // Hard redirect — fastest way to transition after signup
        ...
        // Role is in the JWT user metadata — no extra DB call needed
        // Check email directly for admin fast-path; fall back to user_metadata
        ...
        // Hard redirect — no router.push, no waiting, instant page change
    ...
    // Don't call setLoading(false) on success — page is already navigating
  }
      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] shrink-0 bg-hero-gradient px-10 py-12 relative overflow-hidden">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm leading-relaxed">
            Connect with verified buyers and sellers on the region&apos;s most trusted B2B marketplace.
          </p>
        </div>
        ...
        <div className="space-y-3">
          {[
            ...
            { icon: Building2,   text: "Trusted business network" },
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="card p-7 shadow-cream-md border-cream-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                  className="input min-h-[44px]" placeholder="you@company.com" required autoComplete="email" />
              </div>
            ...
            <p className="text-center text-sm text-gray-500">
              ...
              <button onClick={() => { setIsSignup(!isSignup); setWhatsappError(""); }}
